The /nn contains training history information, simple model training code (with latest epoch model weights saved), and evaluation on separate data (on images and videos attached in /dataset_augmented/misc).
